...
|--------|------------|-----------|-------------|------------|-----------|-------------|
| direct_llm | 0.750 (60/80) | 0.108 | 0.130 | 1.000 (80/80) | 0.033 | 0.083 |
| full_pipeline | 0.800 (64/80) | 0.065 | 0.088 | 1.000 (80/80) | 0.063 | 0.125 |

## Term-Level Metrics (micro-averaged over terms)

| Config | N | Dx P | Dx R | Dx F1 | Tx P | Tx R | Tx F1 |
|--------|---|------|------|-------|------|------|-------|
| direct_llm | 80 | 0.178 | 0.263 | 0.213 | 0.092 | 0.503 | 0.156 |
| full_pipeline | 80 | 0.060 | 0.346 | 0.102 | 0.148 | 0.466 | 0.224 |
